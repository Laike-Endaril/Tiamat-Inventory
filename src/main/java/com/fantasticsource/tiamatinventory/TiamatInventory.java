...
@Mod(modid = TiamatInventory.MODID, name = TiamatInventory.NAME, version = TiamatInventory.VERSION, dependencies = "required-after:fantasticlib@[1.12.2.039d,);required-after:tiamatitems@[1.12.2.000zh,);required-after:tiamatactions@[1.12.2.000zo,)")
